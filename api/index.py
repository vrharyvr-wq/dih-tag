...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "30691"  # Playfab Title Id
        self.SecretKey: str = "R5B93MA48YGF5UPKM1D9RBOQDPDZGJJE6AE16MBFA4SZ7EOX51"  # Playfab Secret Key
        self.ApiKey: str = "OC|1210469208816929|03b42bb22ca029b1216531fcc5094ec7"  # App Api Key (Oculus/Graph API)
